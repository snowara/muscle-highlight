...
// Source: react-muscle-highlighter (ISC License)
// ViewBox: 724x1448, Left/Right separation for per-side editing
// ============================================================
...
const BACK_ORDER = ["lowerBack", "rhomboids", "trapsMid", "trapsLower", "lats", "adductors", "hamstrings", "calves", "glutes", "trapsUpper", "shoulderRear", "triceps"];
...
const FRONT_MUSCLES = {
  ...
  chestMinor: {
    left:     [
      "M305 360c3-8 15-12 22-8 5 3 4 14-1 18-6 5-16 2-20-4-3-5-4-12-1-6z"
    ],
    right:     [
      "M400 360c3-8 15-12 22-8 5 3 4 14-1 18-6 5-16 2-20-4-3-5-4-12-1-6z"
    ],
    common:     [
  ...
  shoulderLateral: {
    left:     [
      "M220 318c5-10 20-14 28-8 4 3 2 15-4 20-7 5-18 2-22-5-3-5-5-12-2-7z"
    ],
    right:     [
      "M480 318c5-10 20-14 28-8 4 3 2 15-4 20-7 5-18 2-22-5-3-5-5-12-2-7z"
    ],
    common:     [
...
// ===============================================================
// BACK VIEW — Muscle Paths (X coords offset +724)
// ===============================================================

const BACK_MUSCLES = {
  trapsUpper: {
    left:     [
      "M1071.06 308.94c5.6 4.92 6.96 17.83 7.43 24.88q1.5 22.3.93 44.68c-.3 10-1.2 18-2.5 25a.5.5 0 01-.9.2c-8-12-16-24-24-38-10.19-26.38-15.6-54.28-26.46-80.58q-3.07-7.43-7.61-14.07-.3-.43.2-.6 12.47-4.28 25.48-4.85c5.54-.25 12.15.86 18.32 1.41 9.7.87 16.77 3.6 24.28 10.22z"
    ],
    right:     [
      "M1163.98 302.12a.43.43 0 01.22.65q-7.08 10.77-11.41 23.37c-10.53 30.61-17.8 42-21 51a.5.5 0 01-.9.1c-5-10-8-20-10-32q-4.27-45.15-5.52-60c-.56-20.28-.74-39.92 2.75-60.43 1.04-6.13 2.77-9.98 7.85-13.85 9.8-7.48 18.02-7.73 30.1-9.11 12.02-1.39 23.92.4 35.53 4.32z"
    ],
    common:     [
  ...
  trapsMid: {
    left:     [
      "M1040 390c5-8 18-12 25-6 4 4 2 16-4 22-8 6-20 3-24-5-3-6-2-15 3-11z"
    ],
    right:     [
      "M1105 390c5-8 18-12 25-6 4 4 2 16-4 22-8 6-20 3-24-5-3-6-2-15 3-11z"
    ],
    common:     [
  ...
  trapsLower: {
    left:     [
      "M1050 440c4-6 14-10 20-5 3 3 1 12-3 16-6 5-16 2-18-4-2-4-2-10 1-7z"
    ],
    right:     [
      "M1100 440c4-6 14-10 20-5 3 3 1 12-3 16-6 5-16 2-18-4-2-4-2-10 1-7z"
    ],
    common:     [
  ...
  rhomboids: {
    left:     [
      "M1030.06 380.44c-3.5-2.1-6.2-4.8-8.5-8.2q-4.5-6.7-6.8-14.3c-1.5-5-1.8-10.2-1.2-15.4q.8-7.1 3.5-13.8a.5.5 0 01.9-.1q4.2 6.8 10.5 12.2c4.8 4.1 8.2 8.5 9.8 14.8q2.5 9.5 1.2 19.3c-.3 2.1-1.2 3.8-3.2 4.8q-3.1 1.5-6.2.7z"
    ],
    right:     [
      "M1137.06 380.44c3.5-2.1 6.2-4.8 8.5-8.2q4.5-6.7 6.8-14.3c1.5-5 1.8-10.2 1.2-15.4q-.8-7.1-3.5-13.8a.5.5 0 00-.9-.1q-4.2 6.8-10.5 12.2c-4.8 4.1-8.2 8.5-9.8 14.8q-2.5 9.5-1.2 19.3c.3 2.1 1.2 3.8 3.2 4.8q3.1 1.5 6.2.7z"
    ],
    common:     [
...
// ===============================================================
// BODY OUTLINE PATHS (from SvgMaleWrapper)
// ===============================================================
