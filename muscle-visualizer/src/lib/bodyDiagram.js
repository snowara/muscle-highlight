...
const FRONT_ORDER = ["core", "adductors", "quadriceps", "tibialis", "calves", "chest", "traps", "shoulders", "biceps", "triceps"];
const BACK_ORDER = ["lowerBack", "rhomboids", "lats", "adductors", "hamstrings", "calves", "glutes", "traps", "shoulders", "triceps"];
