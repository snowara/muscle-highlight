...
const BODY_PART_MUSCLES = {
  ...
  "팔꿈치": ["biceps", "triceps"],
  "팔꿈치 / 어깨": ["shoulderFront", "triceps"],
  "손목": ["biceps", "triceps"],
  "손목 / 바 궤도": ["biceps", "triceps"],
  "손목 / 팔": ["biceps", "triceps"],
  "손목 / 어깨": ["biceps", "triceps", "shoulderFront"],
  "견갑골 / 등 상부": ["trapsMid", "lats"],
  "견갑골 / 어깨": ["trapsMid", "shoulderRear"],
  "견갑골": ["trapsMid", "rhomboids"],
  "흉추 / 요추": ["lowerBack", "core"],
  "팔 / 상체": ["biceps", "triceps"],
  "팔 / 이두근": ["biceps"],
  "팔 / 등": ["lats", "biceps"],
  "팔 / 어깨": ["shoulderFront", "triceps"],
  "팔 / 고관절": ["biceps", "glutes"],
  "어깨": ["shoulderFront", "shoulderLateral", "shoulderRear"],
  "어깨 / 견갑골": ["shoulderRear", "trapsMid"],
  "어깨 / 회전근개": ["shoulderRear"],
  "승모근": ["trapsUpper", "trapsMid"],
  "승모근 / 어깨": ["trapsUpper", "shoulderLateral"],
  "경추 / 목": ["trapsUpper"],
  "경추": ["trapsUpper"],
