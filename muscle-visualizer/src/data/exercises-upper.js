// ============================================================
// exercises-upper.js — 상체 운동 데이터 (가슴, 등, 어깨, 팔)
// ============================================================
...
export const UPPER_EXERCISES = {
  ...
  benchPress: {
    ...
    isIsometric: false,
    primary: { chestMajor: 90, triceps: 60 },
    secondary: { shoulderFront: 45, core: 25 },
  ...
  cableFly: {
    ...
    isIsometric: false,
    primary: { chestMajor: 82 },
    secondary: { shoulderFront: 25, biceps: 15 },
  ...
  inclineBench: {
    ...
    isIsometric: false,
    primary: { chestMajor: 82, shoulderFront: 55 },
  ...
  declineBench: {
    ...
    isIsometric: false,
    primary: { chestMajor: 85, triceps: 55 },
    secondary: { shoulderFront: 30 },
  ...
  dumbbellFly: {
    ...
    isIsometric: false,
    primary: { chestMajor: 80 },
    secondary: { shoulderFront: 25, biceps: 10 },
  ...
  pushUp: {
    ...
    isIsometric: false,
    primary: { chestMajor: 75, triceps: 60 },
    secondary: { shoulderFront: 40, core: 45 },
  ...
  chestPress: {
    ...
    isIsometric: false,
    primary: { chestMajor: 78, triceps: 50 },
    secondary: { shoulderFront: 30 },
  ...
  dip: {
    ...
    isIsometric: false,
    primary: { chestMajor: 75, triceps: 80 },
    secondary: { shoulderFront: 40, core: 25 },
  ...
  latPulldown: {
    ...
    secondary: { trapsMid: 30, shoulderFront: 20, rhomboids: 25 },
  ...
  pullUp: {
    ...
    secondary: { trapsMid: 35, rhomboids: 40, core: 30 },
  ...
  facePull: {
    ...
    isIsometric: false,
    primary: { trapsMid: 65, shoulderRear: 60 },
    secondary: { biceps: 20 },
  ...
  chinUp: {
    ...
    secondary: { trapsMid: 30, rhomboids: 35 },
  ...
  seatedRow: {
    ...
    isIsometric: false,
    primary: { lats: 78, trapsMid: 55 },
    secondary: { biceps: 40, rhomboids: 30, shoulderRear: 20 },
  ...
  shoulderPress: {
    ...
    isIsometric: false,
    primary: { shoulderFront: 88, triceps: 50 },
    secondary: { trapsUpper: 35, core: 30 },
  ...
  lateralRaise: {
    ...
    isIsometric: false,
    primary: { shoulderLateral: 90 },
    secondary: { trapsUpper: 30 },
  ...
  arnoldPress: {
    ...
    snsTags: ["#아놀드프레스", "#어깨운동"],
    isIsometric: false,
    primary: { shoulderFront: 70, shoulderLateral: 60, triceps: 45 },
    secondary: { trapsUpper: 30 },
  ...
  frontRaise: {
    ...
    isIsometric: false,
    primary: { shoulderFront: 78 },
    secondary: { chestMajor: 15, trapsUpper: 20 },
  ...
  rearDeltFly: {
    ...
    snsTags: ["#리어델트", "#후면삼각근"],
    isIsometric: false,
    primary: { shoulderRear: 80, trapsUpper: 40 },
    secondary: { lats: 15 },
  ...
  uprightRow: {
    ...
    snsTags: ["#업라이트로우", "#어깨운동"],
    isIsometric: false,
    primary: { shoulderLateral: 75, trapsUpper: 60 },
  ...
  shrug: {
    ...
    snsTags: ["#슈러그", "#승모근"],
    isIsometric: false,
    primary: { trapsUpper: 90 },
    secondary: { shoulderFront: 15, rhomboids: 25 },
